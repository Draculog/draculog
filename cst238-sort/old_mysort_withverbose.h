...
void bubble_sort (int * values, int size, bool verbose);
void insertion_sort (int * values, int size, bool verbose);
void fast_insertion_sort (int * values, int size, bool verbose);
void selection_sort (int * values, int size, bool verbose);
